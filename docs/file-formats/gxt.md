...
Use `packages/scripts/src/formats/spike-chunsoft-decompress.ts` to decompress files:

```bash
node packages/scripts/src/formats/spike-chunsoft-decompress.ts input.gxt output.gxt
```
